...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bookmark.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKMARK_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKMARK actions', async () => {
      const expectedActions = [
        {
