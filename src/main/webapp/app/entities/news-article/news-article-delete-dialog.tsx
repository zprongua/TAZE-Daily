...
export const NewsArticleDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tazeDailyApp.newsArticle.delete.question">
        <Translate contentKey="tazeDailyApp.newsArticle.delete.question" interpolate={{ id: newsArticleEntity.id }}>
