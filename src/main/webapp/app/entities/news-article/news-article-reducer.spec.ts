...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEWSARTICLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_NEWSARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEWSARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEWSARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEWSARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEWSARTICLE actions', async () => {
      const expectedActions = [
        {
