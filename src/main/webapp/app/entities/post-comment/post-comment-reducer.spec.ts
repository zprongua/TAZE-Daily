...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_POSTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTCOMMENT actions', async () => {
      const expectedActions = [
        {
